    ...
    for epoch in range(max_epochs):
        ...
        for iter in range(iter_start, iter_end):
            ...
            if verbose and iter % show_every == 0:
                # print(data_train.shape[0], lr_decay_every, max_epochs, iters_per_epoch, max_iters)
        ...
        if val_acc > opt_val_acc:
            opt_params = {}        
            opt_params['fc1_w'] = model.net.get_params('fc1_w')
            opt_params['fc1_b'] = model.net.get_params('fc1_b')
            opt_params['fc2_w'] = model.net.get_params('fc2_w')            
            opt_params['fc2_b'] = model.net.get_params('fc2_b')
